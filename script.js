    ...
    function addVisualEffects() {
        ...
        emblems.forEach(emblem => {
            ...
            emblem.addEventListener('mouseleave', function() {
                ...
                this.style.borderColor = 'var(--camouflage-brown)';
            });
        });
    }
    ...
    function startCountdown() {
        ...
        function updateCountdown() {
            ...
            if (distance > 0) {
                ...
                // Opcional: Mostrar en consola o agregar elemento para mostrar
                console.log(`Faltan ${days} días y ${hours} horas para el evento`);
                
                // Puedes descomentar esto si quieres mostrar el contador en la página
                // const countdownElement = document.getElementById('countdown');
                // if (countdownElement) {
                //     countdownElement.textContent = `Faltan: ${days}d ${hours}h`;
                // }
